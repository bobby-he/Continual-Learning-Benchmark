...
class JlNN(nn.Module):
    ...
    def update_model(self, inputs, targets, tasks):
        ...
        with torch.no_grad():
          ...
          b_11 = 20 * ip(self.model.precon_update_list, self.model.precon_update_list)
        ...
        if self.first_update:
          ...
          with torch.no_grad():
            b_21 = 20 * ip(self.model.precon_update_list, self.optimizer.prev_update_list)
            b_22 = 20 * ip(self.optimizer.prev_update_list, self.optimizer.prev_update_list)
