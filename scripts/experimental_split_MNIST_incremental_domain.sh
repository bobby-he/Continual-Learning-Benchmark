...
python3 -u iBatchLearn.py --gpuid $GPUID --repeat $REPEAT --optimizer Adam    --force_out_dim 2 --first_split_size 2 --other_split_size 2 --schedule 4 --batch_size 128 --model_name MLP400 --agent_type experimental_regularization --agent_name SI  --lr 0.001 --reg_coef 2500 3000 3500     | tee ${OUTDIR}/SI_experimental.log
